        ...
        if (javaToolOptions != null && !javaToolOptions.trim().isEmpty()) {
            LoggerFactory.getLogger(CommandFactoryImpl.class)
                .warn("JAVA_TOOL_OPTIONS is defined but will be ignored. " +
                      "Use properties sonar.*.javaOpts and/or sonar.*.javaAdditionalOpts " +
                      "in sonar.properties to change SQ JVM processes options");
        }
        ...
        if (esJavaOpts != null && !esJavaOpts.trim().isEmpty()) {
            LoggerFactory.getLogger(CommandFactoryImpl.class)
                .warn("ES_JAVA_OPTS is defined but will be ignored. " +
                      "Use properties sonar.search.javaOpts and/or sonar.search.javaAdditionalOpts in " +
                      "sonar.properties to change SQ JVM processes options");
        }
    }
