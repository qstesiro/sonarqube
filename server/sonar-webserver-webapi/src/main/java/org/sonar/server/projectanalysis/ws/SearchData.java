...
class SearchData {
    ...
    private static final Logger LOGGER = Loggers.get(SearchData.class);
    ...
    private static ListMultimap<String, EventComponentChangeDto>
    buildComponentChanges(List<EventComponentChangeDto> changes) {
    ...
    static class Builder {
        ...
        private static final Logger LOGGER = Loggers.get(Builder.class);
