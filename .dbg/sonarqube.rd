# 编译
{
    ...
    alias build="./gradlew build --parallel --build-cache --console plain --exclude-task test &&
                 rm -rf sonar-application/build/distributions/sonarqube-8.6.0-SNAPSHOT &&
                 unzip -d sonar-application/build/distributions/ \
                          sonar-application/build/distributions/sonar-application-8.6.0-SNAPSHOT.zip &&
                 rm -rf ./lib &&
                 cp -r sonar-application/build/distributions/sonarqube-8.6.0-SNAPSHOT/lib ./lib &&
                 run"
